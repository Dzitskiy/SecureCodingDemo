...
public sealed class DemoPlaygroundCatalog
{
    private static readonly IReadOnlyList<DemoPlaygroundDefinition> Definitions = BuildDefinitions();

    internal IReadOnlyList<DemoPlaygroundDefinition> GetDefinitions() => Definitions;

    internal DemoPlaygroundDefinition? GetDefinition(string slug)
    {
        return Definitions.FirstOrDefault(item => item.Slug.Equals(slug, StringComparison.OrdinalIgnoreCase));
    }

    private static IReadOnlyList<DemoPlaygroundDefinition> BuildDefinitions()
    {
...
internal sealed class DemoPlaygroundDefinition
{
    public DemoPlaygroundDefinition(
        string slug,
        string category,
        string summary,
        DemoVariant unsafeVariant,
        DemoVariant safeVariant,
    ...
    public DemoVariant Unsafe { get; }
    public DemoVariant Safe { get; }
